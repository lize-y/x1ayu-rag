...
def model_config_menu(model_type: str):
    ...
    while True:
        ...
        if field == "Prompt":
            ...
            new_val = click.prompt("Enter new prompt", default=default_val)
            system_api.update_configuration({"chat": {"sys_prompt": new_val}})
            console.print(f"[green]Updated Prompt successfully.[/green]")
            continue
